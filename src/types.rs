...
impl Hex {
    ...
    pub fn scale(scale: usize, value: &str) -> String {
        ...
        if scale == 0 { return repeat("0").take(v.len()).collect::<String>() }
...
mod tests {
    ...
    pub fn hex_encode_decode_test() {
        ...
        assert_eq!("Unable to decode hex string into bytes vector -- Odd number of digits", error.to_string())
    }
    ...
    pub fn hash_single_concat_test() {
        ...
        assert_eq!(Hex::encode(out), "5fdf86416e09b2b1c0b91afe771d4e6ada2b0daed0066f8aed911109e33f3e34");
    }

    #[test]
    pub fn hash_multiple_concat_test() {
        let depth = 20;
        let mut bytes = Hex::decode("0xabababababababababababababababababababababababababababababababab").unwrap();
        let final_hash = "d4490f4d374ca8a44685fe9471c5b8dbe58cdffd13d30d9aba15dd29efb92930";

        let level_bytes = ["699fc94ff1ec83f1abf531030e324003e7758298281645245f7c698425a5e0e7",
